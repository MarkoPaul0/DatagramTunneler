...
$(BUILD_DIR)main.o: $(SRC_DIR)main.cpp $(BUILD_DIR)DatagramTunneler.o $(VERSION_FILE) directories
	g++ $(CPPFLAGS) -o $(BUILD_DIR)main.o -c $(SRC_DIR)main.cpp

$(BUILD_DIR)DatagramTunneler.o: $(SRC_DIR)DatagramTunneler.h $(SRC_DIR)DatagramTunneler.cpp $(VERSION_FILE) directories #$(SRC_DIR)main.cpp
