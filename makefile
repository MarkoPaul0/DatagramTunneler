...
$(BIN_DIR)datagramtunneler: $(BUILD_DIR)DatagramTunneler.o $(BUILD_DIR)CommandLine.o $(BUILD_DIR)main.o
	g++ $(BUILD_DIR)DatagramTunneler.o $(BUILD_DIR)CommandLine.o $(BUILD_DIR)main.o -o $(BIN_DIR)datagramtunneler

$(BUILD_DIR)main.o: $(SRC_DIR)main.cpp $(SRC_DIR)CommandLine.h $(BUILD_DIR)DatagramTunneler.o $(VERSION_FILE) directories
...
$(BUILD_DIR)DatagramTunneler.o: $(SRC_DIR)DatagramTunneler.h $(SRC_DIR)Protocol.h $(SRC_DIR)DatagramTunneler.cpp $(VERSION_FILE) directories #$(SRC_DIR)main.cpp
