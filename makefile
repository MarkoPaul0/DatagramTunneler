...
$(BUILD_DIR)DatagramTunneler.o: $(SRC_DIR)DatagramTunneler.h $(SRC_DIR)Network.h $(SRC_DIR)Protocol.h $(SRC_DIR)DatagramTunneler.cpp $(VERSION_FILE) directories #$(SRC_DIR)main.cpp
